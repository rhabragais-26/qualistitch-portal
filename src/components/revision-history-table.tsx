                     ...
                     <div className="space-y-3 p-4 border rounded-lg bg-gray-50 animate-in fade-in-50">
                        ...
                        <div className="pt-4 space-y-4">
                             <div className="space-y-2">
                                ...
                                <Select value={newRevisionReason} onValueChange={setNewRevisionReason} disabled={isReadOnly}>
                             ...
                             <div className="flex justify-end">
                                <Button onClick={handleRecordRevision} disabled={isSaving || isReadOnly || !newRevisionReason || !newRevisionDetails.trim()}>
