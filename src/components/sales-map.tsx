...
const cityCoordinates: { [key: string]: [number, number] } = {
    ...
    'Rosario': [13.8444, 121.2056],
    'San Jose': [13.8778, 121.1028],
    'San Juan': [13.8278, 121.3972],
    'San Luis': [13.8417, 120.9250],
