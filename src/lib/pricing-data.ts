...
export const initialProductGroupMapping = {
  'Executive Jacket 1': 'Jacket Type A',
  'Executive Jacket v2 (with lines)': 'Jacket Type A',
  'Turtle Neck Jacket': 'Jacket Type A',
  'Reversible v1': 'Jacket Type B',
  'Reversible v2': 'Jacket Type B',
  'Corporate Jacket': 'Jacket Type C',
  'Polo Shirt (Smilee) - Cool Pass': 'Polo Shirt Type D',
  'Polo Shirt (Smilee) - Cotton Blend': 'Polo Shirt Type D',
  'Polo Shirt (Lifeline)': 'Polo Shirt Type E',
  'Polo Shirt (Blue Corner)': 'Polo Shirt Type E',
  'Polo Shirt (Softex)': 'Polo Shirt Type F',
};

export const initialPricingTiers = {
  'Jacket Type A': {
    logo: { tiers: [ { min: 1, max: 3, price: 1299 }, { min: 4, max: 10, price: 999 }, { min: 11, max: 50, price: 899 }, { min: 51, max: 200, price: 849 }, { min: 201, max: 300, price: 799 }, { min: 301, max: 999, price: 749 }, { min: 1000, max: Infinity, price: 699 }, ], },
    name: { tiers: [ { min: 1, max: 3, price: 1299 }, { min: 4, max: 10, price: 999 }, { min: 11, max: 50, price: 899 }, { min: 51, max: 200, price: 849 }, { min: 201, max: 300, price: 799 }, { min: 301, max: 999, price: 749 }, { min: 1000, max: Infinity, price: 699 }, ], },
    logoAndText: { tiers: [ { min: 1, max: 3, price: 1399 }, { min: 4, max: 10, price: 1099 }, { min: 11, max: 50, price: 999 }, { min: 51, max: 200, price: 949 }, { min: 201, max: 300, price: 899 }, { min: 301, max: 999, price: 849 }, { min: 1000, max: Infinity, price: 799 }, ], },
  },
  'Jacket Type B': {
